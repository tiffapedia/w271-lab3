...
Both the forecasts as well as the graphs tell us that our parsimonous model $\text{ARIMA}(0,1,1)(0,1,1)_4$ predict much more closely to the test data than the autogenerated one $\text{ARIMA}(0,1,1)(0,1,2)_4$. We use this model to determine that e-commerce makes up approximately 10.20% of all retail sales by the fourth quarter of 2017.
